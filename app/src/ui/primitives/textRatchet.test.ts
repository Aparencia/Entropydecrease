 ...
 *
 * ★ T16-B 收紧（2026-09-12）：弱化灰 **249/100 → 63/43**（迁移 186 处；例外 63 处；文件数 44 → 43 见 `f193808d`，批 7 T10 按常数复测）。
 *   棘轮一因此**加一组附则牙**：`RESIDUAL` 逐文件理由（无理由的冻结 ⇒ 红）+ **僵尸豁免**
 *   （已迁走却还挂在豁免表里 ⇒ 红）+ 分类非空（分类表被清空 = 该判据空真）+ 键集双向相等。
 *   字号越界侧**未动**（**551/122**）：迁移时越界值按 R2 原样留在行内（558 → 551 见 `f193808d`；文件数 120 → 122 见批 7 T6 拆件，Σ 551 未变；批 7 T10 按常数复测）。
 *
