...
/** 棘轮一 · 卡片边框 `1px solid #e5e7eb`（含复合写法）的冻结总数（只许降） */
export const FROZEN_BORDER_TOTAL = 240;
...
export const FROZEN_BORDER_BY_FILE: Readonly<Record<string, number>> = {
  ...
  "components/ChatMessageList.tsx": 2, "components/ChatSaveNoteDialog.tsx": 2,
  "components/ChatSidebar.tsx": 1, "components/CitationChips.tsx": 1,
  ...
  "components/ColumnResizer.tsx": 1, "components/EnrichPanel.tsx": 2, "components/FeedFragmentList.tsx": 6,
  "components/GoalAiSection.tsx": 2, "components/GoalCard.tsx": 1, "components/GoalDetail.tsx": 1,
  "components/GoalPlanApprovalDialog.tsx": 2, "components/GroupRowContextMenu.tsx": 1,
  "components/GroupSidebar.tsx": 4, "components/GroupSidebarRow.tsx": 1, "components/ImageGallery.tsx": 1,
  ...
  "components/KnowledgeSampleView.tsx": 1, "components/KnowledgeSystemWizard.tsx": 5,
  "components/KnowledgeTreeView.tsx": 6, "components/LearningLibraryPanel.tsx": 1,
  "components/LiveActivityPanel.tsx": 2, "components/LiveImageStrip.tsx": 3,
  "components/LiveProfileStrip.tsx": 2, "components/MaterialInputPanel.tsx": 2,
  "components/ModelCardCreateDialog.tsx": 1, "components/ModelCardFromNoteDialog.tsx": 2,
  "components/ModelDiskPanel.tsx": 1, "components/NoteAiDialog.tsx": 1, "components/NoteEditView.tsx": 4,
  "components/NoteHeaderActions.tsx": 1, "components/NoteImage.tsx": 1, "components/NoteLinkToSystem.tsx": 2,
  "components/NoteListBatchMenu.tsx": 2, "components/NoteListToolbar.tsx": 3,
  "components/NoteListView.tsx": 1, "components/NoteMarkdown.tsx": 1,
  ...
  "components/SystemStatusBadge.tsx": 1, "components/TaskConversationView.tsx": 4,
  "components/TaskLaunchDialog.tsx": 1, "components/TaskThreadCard.tsx": 1, "components/VersionPanel.tsx": 3,
  "components/VideoImportPanel.tsx": 1, "components/VocabManager.tsx": 4, "components/WebImportPanel.tsx": 2,
  "components/WebInboxPanel.tsx": 1, "components/WeekContractCard.tsx": 3,
...
/** 棘轮二 · 越界圆角 `6|12|14|999|2` 的冻结总数（`3/4/5/8/10` 与 `0` 按映射表处理，不入棘轮） */
export const FROZEN_RADIUS_OUTLIER_TOTAL = 270;
...
export const FROZEN_RADIUS_OUTLIER_BY_FILE: Readonly<Record<string, number>> = {
  ...
  "components/EnrichPanel.tsx": 4, "components/FeedFragmentList.tsx": 1, "components/GoalAiSection.tsx": 1,
  ...
  "components/GroupSidebar.tsx": 4, "components/GroupSidebarRow.tsx": 2, "components/ImageGallery.tsx": 1,
  ...
  "components/NoteAiDialog.tsx": 4, "components/NoteEditView.tsx": 1, "components/NoteHeaderActions.tsx": 3,
  ...
  "components/RefineStrategyPicker.tsx": 3, "components/RefineWorkbench.tsx": 5,
  ...
  "components/TaskThreadCard.tsx": 3, "components/VersionPanel.tsx": 5, "components/VideoImportPanel.tsx": 1,
  "components/VocabManager.tsx": 4, "components/WebArticleView.tsx": 4, "components/WebImportPanel.tsx": 1,
  "components/WebInboxPanel.tsx": 1, "components/WeekContractCard.tsx": 1,
  "components/action-center/ActionCenterPanel.tsx": 7, "components/chat/ChatLaunchMenu.tsx": 4,
  "components/note-selection/SelectionActionMenu.tsx": 1, "components/review/ReviewSessionPanel.tsx": 1,
...
/** 棘轮三 · 阴影 `boxShadow:` 的冻结总数（规格 §4.1 红线：批 4 迁移时不得临时硬编码阴影） */
...
/**
 * 域内 `<Surface` 开标签的冻结数（**今日 0**）。
 * Why 冻结一个"零"：`tmp/t17a/measure.mjs` 实测今日**全仓 0 个调用点用 `Surface`** ⇒ ADR-033 §4 的
 *   「调用点不得用行内 `style` 覆盖原语语义」这条判据对真实代码是**空真**的。把它冻结成常数，
 *   T17-B 迁移后必须**手工抬高**（那一刻空真结束、判据开始有真实输入）—— 不许让它静默地一直空转。
 */
export const FROZEN_SURFACE_TAG_TOTAL = 0;

/**
 * 锚（三份；判据 ④ 逐条比对）—— `entries` = 基线条目数（防"表被悄悄删条目"）、
 * `file/value` = 一个**具名文件**的冻结值（防"仪器静默失效后所有计数都变 0 而总数判据仍绿"）。
 */
export const BORDER_ANCHOR = { entries: 111, file: "components/action-center/ActionCenterPanel.tsx", value: 11 } as const;
export const RADIUS_OUTLIER_ANCHOR = { entries: 112, file: "components/KnowledgeSystemWizard.tsx", value: 9 } as const;
...
export const SHADOW_RESIDUAL: readonly { file: string; kind: ShadowResidualKind; reason: string }[] = [
  ...
  { file: "components/BrowserChrome.tsx", kind: "anchored-menu", reason: "B1 锚定菜单族（计划 §表 4 的 TABLE4_ALIAS，`data-app-menu` 右键菜单，`zIndex(\"popover\")`）⇒ 不迁原语；T17-B 只许把字面量换成 `boxShadow: \"var(--ed-shadow-1)\"`（token 引用不是字面量）" },
  ...
  { file: "components/GroupRowContextMenu.tsx", kind: "anchored-menu", reason: "B1 的 `NON_MIGRATED_14` 成员（硬守卫：该文件源码不得出现 `ui/primitives`）⇒ 不迁原语；T17-B 只许把字面量换成 `boxShadow: \"var(--ed-shadow-1)\"`（token 引用不是字面量）" },
