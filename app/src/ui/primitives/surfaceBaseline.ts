 ...
 *   ⇒ 三族收紧读数（T17-B 后 → **批 7 T7 重冻后的现值**）：边框 **240 → 226 → 201 处 / 111 → 108 → 99 文件** ·
 *     越界圆角 **270 → 261 → 254 处 / 112 → 109 → 107 文件** ·
...
export const FROZEN_BORDER_BY_FILE: Readonly<Record<string, number>> = {
  ...
  "components/NoteListView.tsx": 1, "components/NoteMoveToGroupMenu.tsx": 1,
...
export const FROZEN_RADIUS_OUTLIER_BY_FILE: Readonly<Record<string, number>> = {
  ...
  "components/NoteAiDialog.tsx": 4, "components/NoteEditView.tsx": 1,
  "components/NoteHeaderActions.tsx": 2, "components/NoteImage.tsx": 2,
  "components/NoteLinkToSystem.tsx": 2, "components/NoteListToolbar.tsx": 2,
  "components/NoteMarkdown.tsx": 1, "components/NoteMoveToGroupMenu.tsx": 1,
