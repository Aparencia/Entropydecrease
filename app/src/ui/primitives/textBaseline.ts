 ...
 *   → **T16-B 迁移后 63/43**（2026-09-12 T16-B 收紧；文件数 44 → 43 见 `f193808d`）。字号越界处/文件：**604/124 → 576/122 → 551/123**（Σ 551 未变 · 文件 120 → 122 见批 7 T6 拆件；批 7 T10 按常数复测）
 ...
 *   **+1**：总量 **63 → 64** / 该文件 **1 → 2**（条目数、锚、字号侧未动；机理详见 `textRatchet` ⑥）—— 批 7 T10 更正：**64 已在 `f193808d` 随一次真实迁移收紧回 63**（现常数 == Σ表 == 实测），该文件 **1 → 2** 仍成立。
 *
 ...
 * ⚠️ T16-B **未动本表**：迁移时越界值一律**原样留在行内**（R2：只登记，交批 5/6）⇒ 551/123 不变。
 */
