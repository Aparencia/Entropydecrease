      ...
      <div style={{ position: "relative" }}>
        ...
        {colorPickerOpen && (
          <div
            ...
            style={{ position: "absolute", top: "100%", right: 0, zIndex: zIndex("popover"), background: "#fff", border: "1px solid #e5e7eb", borderRadius: 6, padding: 8, boxShadow: "0 4px 12px rgba(0,0,0,0.12)" }}
          >
            <NoteColorPicker
