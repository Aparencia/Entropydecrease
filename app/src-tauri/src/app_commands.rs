...
pub fn handle() -> impl Fn(tauri::ipc::Invoke<tauri::Wry>) -> bool + Send + Sync + 'static {
    anchored(tauri::generate_handler![
        ...
        crate::commands_goals::add_goal_milestone,
        crate::commands_goals::update_goal_milestone,
        crate::commands_goals::delete_goal_milestone,
        crate::commands_goals::set_goal_milestone_status,
        crate::commands_goals::bind_goal_group,
        crate::commands_goals::unbind_goal_group,
        crate::commands_goals::suggest_goal_milestones,
