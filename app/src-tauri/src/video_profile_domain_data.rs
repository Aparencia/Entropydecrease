...
pub fn seed_words(kind: DomainKind) -> Vec<String> {
    let words: &[&str] = match kind {
        ...
        DomainKind::Music => &[
            "音乐", "乐理", "钢琴", "吉他", "和弦", "节拍", "乐谱", "演唱", "编曲", "旋律", "音符", "音阶",
        ],
        DomainKind::Handcraft => &[
            "手工", "DIY", "编织", "折纸", "陶艺", "木工", "缝纫", "黏土", "串珠",
        ],
        DomainKind::Exam => &[
        ...
        // v0.13.6：美食烹饪（烘焙自手工迁入——Handcraft 词表已同步移除）
        DomainKind::Cooking => &[
            "美食", "菜谱", "做饭", "炒菜", "炖菜", "烤箱", "烘焙", "蛋糕", "面包", "配料", "调味", "料理",
        ],
        // v0.13.6：摄影视频制作
        ...
        // v0.13.6：写作阅读
        DomainKind::Writing => &[
            "写作", "小说", "文案", "投稿", "阅读", "读后感", "书评", "文笔", "叙事", "稿件", "写作技巧",
        ],
        // v0.13.6：数码硬件
