...
fn parse_full_response() {
    let raw = r#"{"total_balance":12.34,"grants_balance":10.0,"topped_up_balance":2.34,"currency":"CNY"}"#;
...
fn parse_invalid_number_treated_as_zero() {
    ...
    let raw = r#"{"total_balance":"abc","grants_balance":1,"currency":"USD"}"#;
