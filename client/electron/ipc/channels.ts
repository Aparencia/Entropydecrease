...
export const IPC_CHANNELS = {
  ...
  AI_RESCUE: 'ai_rescue',
  AI_ERROR_PATTERN: 'ai_error_pattern',
  AI_GENERATE_QUIZ: 'ai_generate_quiz',
  AI_CONTENT_TIER: 'ai_content_tier',
  AI_CONFLICT_DETECT: 'ai_conflict_detect',
  AI_CONCEPT_PRECHECK: 'ai_concept_precheck',
