...
| app/src-tauri/src/live_session.rs | ~335 | v0.3.0 后：FusionTracker + 会话编排循环 + 后台融合线程三职责内聚于会话生命周期模块；拆出需跨函数传递 stop/epoch/speech_active/db/app 上下文 | 若再增长：融合线程任务拆至 live_session_fusion.rs，编排循环拆至 live_session_loop.rs |
