...
| 归档日期 | 内容摘要 | 未偿债务 |
|----------|---------|----------|
| 2026-08-18 | 基线 + 三轮滚动 + 四轮技术债专项：二次审查（P0 DXGI SDKVersion）与 P0/P1 修复完成；四轮 19 笔未偿全部偿还 + 当日 TD-032（sherpa-onnx 空热词流崩溃）偿清；REQ-033 审查追加 TD-033（窗口跨显示器 DXGI 不更新）；无文档移入（ADR/versions/Foresight 均活跃）；累计已偿 39 笔 | TD-033（P2） |
