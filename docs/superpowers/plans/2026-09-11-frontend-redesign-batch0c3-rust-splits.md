...
4. **`db 写 → pause.request_* → app.emit` 三元组顺序**在 6 处（424–439 / 460–473 / 517–527 / 830–833 / 848–862 / 869–872）反复出现，不可重排；**16 处 emit 的事件名逐字不变**（⚠️ 本行原写 15 —— 评审复算基线实为 **16** 处、9 个 live 事件名计数不变；分析报告 §1 的 15 是错的，登记表已记录）。
