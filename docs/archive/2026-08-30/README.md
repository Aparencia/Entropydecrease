...
- **状态**：昨日 3 笔 carried（TD-040 / TD-19-D / TD-24-A）核实均未偿还 → 继承；**新增 open 1 笔**——TD-2026-08-30-A（ClassroomPage 607 行超 600 硬限：预存债务 v0.15 实测纠偏，拆分计划 LiveCaptureCard 已登记豁免）
- **观察项**：继承 5 项未决（28-1/2/3、29-1/3；29-2 已修复）+ 新增 2 项（30-1 绝对路径引用不改写保持边界 / 30-2 历史孤儿图垃圾回收后续）
- 权威清单：[tech-debt.md](./tech-debt.md)（3 carried + 1 open + 7 观察项）
