# 技术债清单（权威：2026-08-19，新增代码审查后滚动）

> 本清单为当前唯一权威债务清单，归档日滚动更新；旧归档清单仅历史追溯。
> 来源：昨日（2026-08-18）清单滚动——TD-040 维持 carried（deliberate 有意不修）。
> 今日（2026-08-19）：结构模型版新增代码审查（版面/表格/公式模型 + 课后精修），
> 发现 H1-H3/M1/M2/M4/L1/L3 全部当日修复（提交 c5eae08 + 65c950a，见下）。
