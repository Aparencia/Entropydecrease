...
> 状态：**提议**（2026-09-03 草案，随 [v0.19 设计规格](../superpowers/specs/2026-09-03-v0.19-rag-retrieval-discovery-design.md) 批准后转已接受）
> 关联：[v0.19 设计规格（待批准）](../superpowers/specs/2026-09-03-v0.19-rag-retrieval-discovery-design.md) · [ADR-010](./ADR-010-gap-filling-ai.md)（AI 为增强层·本地兜底铁律）· [ADR-024](./ADR-024-knowledge-system-layer.md)（体系只引用不收纳·AI 只建议不生成）· [ADR-028](./ADR-028-ai-goal-planner.md)（建议制确认落库/预算硬顶/双闸门范式）· REQ-258~262（随批准登记）
