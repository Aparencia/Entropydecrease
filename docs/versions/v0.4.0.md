...
> **状态**: 实施中（2026-08，M0 已偿 TD-033；M1 已实施——EP 按 spike 结论由 DirectML 改为 CUDA，见 ADR-009；M2 已实施——spike 确认 oar-ocr bbox 暴露，动态 ROI 落地；M3 已实施——partial 节流已有（150ms），补灰→黑原位静默修正 + 投票器 hash 短路；REQ-033 真机验收待用户执行）
