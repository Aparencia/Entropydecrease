...
深海的隔绝感与安全感。如潜入静谧深海——没有刺眼的白光，只有生物荧光般的微光引导前行，赛博青的 AI 呼吸灯消解孤独感。
...
| `--kb-brand-400` | `#6366F1` | 品牌强调色（主用） |
| `--kb-brand-500` | `#818CF8` | 品牌核心色 |
| `--kb-brand-600` | `#6366F1` | 品牌深色 |
...
| `--kb-accent-500` | `#06B6D4` | 辅助核心色 |
| `--kb-accent-600` | `#22D3EE` | 辅助亮色 |
...
| `--kb-brand-500` | `#3B82F6` | 品牌核心色 |
| `--kb-brand-600` | `#2563EB` | 品牌深色 |
...
**品牌色（靛蓝）：**
`#1A1B3A` `#252755` `#353878` `#4A4E9E` `#6366F1` `#818CF8` `#6366F1` `#5558E0` `#4649C8` `#373AB0`

**辅助色（赛博青）：**
`#0A1E28` `#0E2E3C` `#164E63` `#0E7490` `#0891B2` `#06B6D4` `#22D3EE` `#67E8F9` `#A5F3FC` `#CFFAFE`
...
**功能色：**
`#60A5FA` `#FBBF24` `#82C9A3` `#22D3EE` `#F87171` `#FB923C` `#4ADE80`
...
**辅助色（琥珀）：**
`#FFF7ED` `#FFEDD5` `#FED7AA` `#FDBA74` `#FB923C` `#F59E0B` `#D97706` `#B45309` `#92400E` `#78350F`
...
**功能色：**
`#3B82F6` `#F59E0B` `#6BAF8A` `#06B6D4` `#EF4444` `#F97316` `#22C55E`
...
### 四、 总结：用户的第一眼体验
当用户打开课伴：
*   **如果是夜晚**，他潜入了一片**静谧的深海**。没有刺眼的白光，只有生物荧光般的微光引导他前行，孤独感被赛博青的AI呼吸灯消解。
