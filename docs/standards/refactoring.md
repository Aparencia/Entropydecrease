...
## 熵减项目衔接：与 AI 编程规范 §1/§6 的关系

本文档的通用重构手法在熵减项目中受以下硬性约束（详见 [ai-coding.md](./ai-coding.md) 第二部分）：

- **§1 单文件 ≤300 行**："过大类/文件"坏味道在本项目有明确阈值——>600 行必须硬拆；300-600 行登记豁免清单待专项重构（策略 B，见 product/migration-spec.md 豁免清单）
