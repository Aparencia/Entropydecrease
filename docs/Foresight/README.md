...
| [brainstorming-video-profile-detection.md（[ ] 已归档）](../archive/2026-08-21/brainstorming-video-profile-detection.md) | 档案自动检测准确度头脑风暴（2026-08：根因代码级定位（仅标题信号在生效/关键词重叠/无负证据/无反馈闭环）+ 20 项候选 + 三批落地建议；已被四维解耦 v2 取代，2026-08-21 归档） |
...
| [video-profile-framework-v2.md（[ ] 已归档）](../archive/2026-08-21/video-profile-framework-v2.md) | 视频档案框架 v2 设计（2026-08-21：会话 33 实证驱动，四维解耦重新设计——形态 7 类 × 画面价值 4 档 × 领域标签 × 语言预留 + 叙事变体；v0.9.0 M1~M5 实施完成，2026-08-21 归档） |
| [long-term-optimization-inventory.md](./long-term-optimization-inventory.md) | 长期优化清单——全面调研汇总（2026-08-20：六源合并，v0.8.0 AI 线之后批次的排期输入） |
...
| [competitive-analysis-knowledge-system-layer.md（[ ] 已归档）](../archive/2026-08-28/competitive-analysis-knowledge-system-layer.md) | 竞品调研：知识体系层与学习闭环赛道（2026-08-23：五层竞品地图 + 定价锚点 + 「应用/决策」零竞品带判读；v0.13 立项依据——v0.13 系列已交付，2026-08-28 归档） |
| [competitive-analysis-knowledge-system-software.md（[ ] 已归档）](../archive/2026-08-28/competitive-analysis-knowledge-system-software.md) | 知识体系类软件调研：第二大脑/PKM 赛道细分（2026-08-23：五流派图谱 + 四件套支持度对比 + 方法论空白在"检验"不在"组织"；含上轮结论修订与 v0.13 spec 输入——v0.13 系列已交付，2026-08-28 归档） |
| [competitive-analysis-personal-library.md](./competitive-analysis-personal-library.md) | 个人电子图书馆调研（2026-08-23，未排期：五层地图——书库管理/书店平台/摄取回顾/文献库/AI 问书；Pocket 关停与 Omnivore sunset 退潮信号；"管书"与"助学"断裂带与熵减同构） |
| [personal-knowledge-system-layer-integration.md（[ ] 已归档）](../archive/2026-08-28/personal-knowledge-system-layer-integration.md) | 整合分析·方案 B：个人知识体系指南 × 熵减（2026-08-23：范式判断/映射总表/数据模型概要/理念修订提案/防线扩展；已落位 v0.13 系列并交付，2026-08-28 归档） |
| [source-personal-knowledge-system-guide-v2.md（[ ] 已归档）](../archive/2026-08-28/source-personal-knowledge-system-guide-v2.md) | 指南源文档存档（用户提供《个人知识体系搭建指南（综合版）》v2.0 原文——随整合分析一并归档，2026-08-28） |
