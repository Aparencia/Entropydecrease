...
> 状态：前瞻调研（2026-08-23；**已输入 v0.13.5 立项**——"体会层"（书籍笔记组＋知识树附加，不存书内容）见 [v0.13.md 规划](../versions/v0.13.md#v0135-规划书籍笔记组与知识树附加方案-c2026-08-23-立项)）——回答"有没有个人电子图书馆"并以品类视角评估对熵减知识体系层的延展价值
...
1. **书籍本体内容不作进料（维持）**：内容供给红线 + Calibre/微信读书已占"管书/看书"；**"体会层"已立项 v0.13.5**——正确形态＝books 元数据壳＋书籍笔记组（体会=组内用户笔记）＋挂知识树，不存书内容（零版权、零存储负担、接学习循环）；不做书库管理（Calibre 不可战胜也不值得）。
